document.addEventListener('DOMContentLoaded', () => {
    ...
    let loveText; // Special "Happy Birthday Maadam Ji" text near the heart
    ...
    function loadFont() {
        ...
        fontLoader.load(
            ...
            function (font) {
                loadedFont = font;
                create3DTexts();
                createLoveText(); // Create the special "<3 <3 <3 <3" text
            },
            function (progress) {
    ...
    function createLoveText() {
        ...
        const loveTextGeometry = new THREE.TextGeometry("HAPPY BIRTHDAY MAADAM JI", {
            font: loadedFont,
    ...
    function createSimpleLoveText() {
        // Fallback: create simple " <3 Ya " text using basic geometry
    ...
    function animate() {
        ...
        // Animate the special "18th bday <3" text with enhanced and faster animation
        if (loveText) {
